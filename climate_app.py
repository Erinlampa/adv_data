...
def homepage():
    ...
    return(
        f"<b><u><h2>Available Routes:<br/></b></u></h2>"
      
        f"<li><b>/api/v1.0/precipitation</li></b>"
        f"Query dates and temperature from the last year. <br/><br/>"
        ...
        f"<li><b>/api/v1.0/yyyy-mm-dd/</li></b><br/>"
        f"Returns an Average, Max, and Min temperature for given date.<br/><br/>"

        f"<li><b>/api/v1.0/yyyy-mm-dd/yyyy-mm-dd/</li></b><br/>"
...
def precipitation():
    ...
    results = session.query(Measurement.date, Measurement.tobs).        filter(Measurement.date <= "2016-01-01", Measurement.date >= "2016-01-01").        all()
...
def temp_obs():
    ...
    results = session.query(Station.name, Measurement.date, Measurement.tobs).        filter(Measurement.date >= "2016-01-01", Measurement.date <= "2017-01-01").        all()
